...
options.put("Sdk_Info_Base_Url", "https://sdk-info-stage.gimbal.com/service/"); 
Gimbal.setApiKeyWithOptions(this.getApplication(), "key", options);
```

//IOS
```
NSDictionary *options = @{@"GIMBAL_SERVER_BASE_URL" : @"https://api-dev.gimbal.com/service/",
@"PROXIMITY_SERVER_BASE_URL" : @"https://proximity-dev.gimbal.com/",
...
@"EXPERIENCE_SERVER_BASE_URL" : @"https://cep-stage.gimbal.com/autoJoin/v2",
@"ANALYTICS_SERVER_BASE_URL" : @"https://analytics-server-stage.gimbal.com/service/",
@"FASTPAYLOAD_ANALYTICS_SERVER_BASE_URL": @"https://analytics-server-stage.gimbal.com/",
@"SDK_CONFIGURATION_SERVER_BASE_URL":@"https://sdk-configuration-stage.gimbal.com/service/",
 @"SDK_INFO_SERVER_BASE_URL" : @"https://sdk-info-stage.gimbal.com/service/"};
